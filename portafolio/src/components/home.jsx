...
function Inicio() {
    ...
    return (
        <div id="home" className="flex flex-col justify-center items-center min-h-screen">
            ...
            <a href={`${process.env.PUBLIC_URL}/pdf/CV-Javier-Nanco.pdf`} download="CV-Javier-Nanco.pdf">
                <button className="flex items-center mt-4 custom-bg custom-hover text-white font-bold py-2 px-5 rounded-xl">
                    ...
                    <img src={`${process.env.PUBLIC_URL}/other-icon/download.svg`} alt="Download Icon" />
                </button>
            </a>
            <button className="boton-abajo" onClick={() => {
                document.getElementById('quien-soy').scrollIntoView({ behavior: 'smooth' });
            }}>
                <img src={`${process.env.PUBLIC_URL}/arrow/down.svg`} alt="Scroll Down Icon" />
            </button>
        </div>
    );
}
